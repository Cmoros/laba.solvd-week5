...
describe("LinkedList", () => {
  ...
  describe("contains", () => {
    it("should return true if an item is in the list", () => {
    ...
    it("should return false if an item is not in the list", () => {
      const list = new LinkedList<number>(1, 2, 3);
  ...
  describe("remove", () => {
    ...
    it("should not remove anything if the list is empty", () => {
      const list = new LinkedList<number>();
      expect(list.remove(1)).toBe(false);
    });

    it("should not remove anything if the item is not in the list", () => {
      const list = new LinkedList<number>(1, 2, 3);
      expect(list.remove(4)).toBe(false);
      expect(list.size()).toBe(3);
    });

    it("should remove items from the last", () => {
      const list = new LinkedList<number>(1, 2, 3);
      expect(list.getLast()).toBe(3);
  ...
  // describe("haveLoop", () => {
  //   it("should return true if the list has a loop", () => {
  ...
  //   it("should return false if the list does not have a loop", () => {
  //     const list = new LinkedList<number>(1, 2, 3);
